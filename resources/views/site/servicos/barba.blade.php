...
@section('conteudo')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 video-wrap mb-5">
                    <img src="../images/barbas/barbaComToalha.png" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 pl-md-5">
                    <h3>Barba Hot Towel</h3>
    ...
    <section class="pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6 video-wrap mb-5">
                    <img src="../images/barbas/barbaFade.png" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 pl-md-5">
                    <h3>Barba Fade</h3>
    ...
    <section class="pt-5 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6 video-wrap mb-5">
                    <img src="../images/barbas/barbaTradicional.png" alt="Image placeholder" class="img-fluid">
                </div>
                <div class="col-md-6 pl-md-5">
                    <h3>Corte de Barba Tradicional</h3>
